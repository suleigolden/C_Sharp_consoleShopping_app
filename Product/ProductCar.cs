...
namespace Product
{
    public class ProductCar
    {
        ...
        #endregion
        #region properties
        string EnginType = string.Empty;

        public string EnginType1
        {
            get { return EnginType; }
            set { EnginType = value; }
        }
        string EnginCapacity = string.Empty;

        public string EnginCapacity1
        {
            get { return EnginCapacity; }
            set { EnginCapacity = value; }
        }
        ...
        public string PicUpDate1
        {
            get { return PicUpDate; }
            set { PicUpDate = value; }
        }
